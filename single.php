...
<html>
<head>
	<title>The Daily News | Single </title>
	 ...
	 <div class="container">
		 <div class="content-grids">
			 <div class="col-md-8 content-main">
				...
				$single_post = $single_data->response->content;
				?>
				 <div class="content-grid-sec">
					 <div class="content-sec-info">
							 <h3><a href="single.php?id=<?php echo $post->id ?>"><?php echo $single_post->webTitle?></a></h3>
							 <h4><?php echo $single_post->webPublicationDate?> : <a href="section.php?id=<?php echo $single_post->sectionId?>"><?php echo $single_post->sectionName?></a></h4>
					 </div>
				 </div>	 
			 </div>
