...
<html>
<head>
	<title>The Daily News | Search </title>
	 ...
	 <div class="container">
		 <div class="content-grids">
			 <div class="col-md-8 content-main">
                ...
                <?php 
                $ch = curl_init();
                curl_setopt($ch, CURLOPT_URL, "https://content.guardianapis.com/search?q=".$_POST['key_word']."&api-key=7f9247e7-08ac-4514-9167-7284248e8bfe");
                curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
                $output = curl_exec($ch);
                curl_close($ch); 
                $data = json_decode($output);
                ...
                <?php if($search_result){ ?>
                    <div class="content-grid">
					 <div class="content-grid-head">
						 <h3><?php echo strtoupper($_POST['key_word']) ?> RESULTS</h3>
					 </div>
				 </div>	
                ...
                <?php } } else{?>	
                    <div class="content-grid">
					 <div class="content-grid-head">
						 <h3>No Result Found !! Try Another One.</h3>
					 </div>
				 </div>		 
				<?php } ?>			 
			 </div>
